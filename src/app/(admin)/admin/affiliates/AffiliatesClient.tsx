...
const statusConfig: Record<string, { label: string; className: string }> = {
  active: { label: "Active", className: "bg-[#a7f0ba] text-[#0e6027]" },
  pending: { label: "Pending", className: "bg-[#fcf4d6] text-[#8e6a00]" },
  suspended: { label: "Suspended", className: "bg-[#ffd7d9] text-[#a2191f]" },
};
...
export function AffiliatesClient({ initialAffiliates, statusCounts, totalEarnings, totalPending }: AffiliatesClientProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {totalPending > 0 && (
        <div className="flex items-center gap-3 p-4 bg-amber-50 rounded-none border border-amber-100">
          ...
          <div className="space-y-5">
              ...
              <div>
                ...
                <div className="space-y-2 max-h-64 overflow-y-auto">
                  {selectedAffiliate.referral_list.map((ref: any) => (
                    <div key={ref.id} className="flex items-center justify-between rounded-none border border-[var(--dash-hairline)] bg-[var(--dash-canvas)] p-3">
                      <div>
            ...
            {selectedAffiliate.pending_payout > 0 && (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-violet-600 text-white font-semibold rounded-none hover:bg-violet-700 transition-colors"
              >
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button
                ...
                className="px-4 py-2 font-bold text-white carbon-btn-primary disabled:opacity-50"
              >
