    ...
    <div className="min-h-screen bg-[#0c0c0c] text-white flex flex-col">
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 py-24 mt-20">
        ...
        <div className="prose prose-invert max-w-none text-white/70 leading-relaxed space-y-6">
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">1. Know Your Customer (KYC)</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">2. Prohibited Jurisdictions</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">3. Payment and Payout Source Verification</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">4. Monitoring and Reporting</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-white mt-8 mb-4">5. Account Suspension</h2>
          <p>
