    ...
    <div className="min-h-screen bg-[var(--paper)] text-[var(--ink-950)] flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 py-24 mt-20">
        ...
        <div className="prose prose-neutral max-w-none text-[var(--ink-700)] leading-relaxed space-y-6">
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">What are cookies?</h2>
          <p>
            Cookies are small data files that are placed on your computer or mobile device when you visit a website. Cookies are widely used by website owners in order to make their websites work, or to work more efficiently, as well as to provide reporting information.
          </p>

          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">Why do we use cookies?</h2>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">How can I control cookies?</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">Updates to this policy</h2>
          <p>
