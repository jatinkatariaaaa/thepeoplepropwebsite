    ...
    <div className="min-h-screen bg-[var(--paper)] text-[var(--ink-950)] flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 py-24 mt-20">
        ...
        <div className="prose prose-neutral max-w-none text-[var(--ink-700)] leading-relaxed space-y-6">
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">1. Acceptance of Terms</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">2. Services Provided</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">3. Evaluation Rules and Conduct</h2>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">4. Fees and Refunds</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">5. Intellectual Property</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">6. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">7. Termination</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">8. Governing Law</h2>
          <p>
