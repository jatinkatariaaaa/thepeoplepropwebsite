    ...
    <div className="min-h-screen bg-[var(--paper)] text-[var(--ink-950)] flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 py-24 mt-20">
        ...
        <div className="prose prose-neutral max-w-none text-[var(--ink-700)] leading-relaxed space-y-6">
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">1. Simulated Trading Environment</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">2. No Financial Advice</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">3. High Risk of Loss</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">4. Hypothetical Performance Results</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">5. Technological Risks</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">Acknowledgment</h2>
          <p>
