    ...
    <div className="min-h-screen bg-[var(--paper)] text-[var(--ink-950)] flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 py-24 mt-20">
        ...
        <div className="prose prose-neutral max-w-none text-[var(--ink-700)] leading-relaxed space-y-6">
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">1. Information We Collect</h2>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">2. How We Use Your Information</h2>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">3. Data Sharing and Disclosure</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">4. Data Security</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">5. Your Data Rights</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">6. Changes to This Policy</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--ink-950)] mt-8 mb-4">7. Contact Us</h2>
          <p>
