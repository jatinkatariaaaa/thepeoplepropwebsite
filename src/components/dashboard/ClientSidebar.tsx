      ...
      <aside className={cn(
        ...
        <div className="p-4 border-t border-[var(--border)]">
          <button 
            ...
            className="flex items-center gap-3 px-3 py-2.5 w-full rounded-xl transition-all text-[var(--ink-500)] hover:text-red-600 hover:bg-red-50 font-medium text-[14px]"
          >
