...
export function DashboardPreview() {
  return (
    <section className="relative py-24 md:py-32 overflow-hidden bg-[#FAFAFA]">
      {/* Background Decor */}
      <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-[800px] h-[800px] bg-[var(--accent)] opacity-[0.03] rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/4 w-[600px] h-[600px] bg-blue-600 opacity-[0.02] rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8 relative z-10">
        <AnimatedSection className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          ...
          <div className="flex flex-col relative lg:pr-12">
            ...
            <h2 className="text-[42px] sm:text-[56px] lg:text-[64px] font-bold leading-[1.05] tracking-tight text-[var(--ink-950)] mb-6">
              Powerful Custom<br />
              Trading <span className="word-serif text-[var(--accent)]">Technology</span>
            </h2>

            <p className="text-[18px] leading-relaxed text-[var(--ink-500)] mb-8 max-w-md">
          ...
          <div className="relative flex justify-center lg:justify-end w-full perspective-1000">
            <div className="relative w-full max-w-lg lg:max-w-none transform-gpu transition-transform duration-700 hover:rotate-y-0 hover:rotate-x-0 rotate-y-[-10deg] rotate-x-[5deg]">
              {/* Outer Glow */}
              <div className="absolute inset-0 bg-[var(--accent)]/5 blur-[40px] rounded-3xl" />
