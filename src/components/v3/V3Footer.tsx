      ...
      <div className="mx-auto max-w-[1440px] px-5 pb-8 pt-16 lg:px-10 lg:pt-24">
        <div className="mb-16 grid grid-cols-1 gap-12 lg:grid-cols-[1fr_2fr]">
          ...
          <div className="flex flex-col">
            <span className="mb-2 text-3xl font-black tracking-tight">
              The People Prop
            </span>
            <p className="mb-8 max-w-[300px] text-[15px] font-medium opacity-70">
              Evaluating traders worldwide. Built by traders, for traders. No
              hidden rules, just real capital scaling.
            </p>

            <h4 className="mb-4 text-[14px] font-bold uppercase tracking-widest opacity-50">
              Newsletter
            </h4>
            <div className="mb-8 flex max-w-[320px] border-b-2 border-[#0c0c0c] pb-2">
              ...
              />
              <button
                className="text-xl font-medium transition-transform hover:translate-x-1"
            ...
            <div className="flex gap-4">
              <Link
                href="#"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-[#0c0c0c]/20 transition-all hover:bg-[#0c0c0c] hover:text-[#cbfb45]"
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 lg:justify-items-end">
            <div className="flex flex-col gap-4">
              <h4 className="mb-2 text-[14px] font-bold uppercase tracking-widest opacity-50">
                Platform
              </h4>
              <Link
                href="/dashboard"
        ...
        <h2
          className="my-8 select-none text-center font-black leading-[0.8] tracking-[-0.05em] text-[#0c0c0c]"
        ...
        <div className="flex flex-col gap-8 border-t border-[#0c0c0c]/10 pt-8">
          <p className="mx-auto max-w-6xl text-center text-[12px] leading-relaxed opacity-60 md:text-left">
            <strong>Risk Warning:</strong> The People Prop provides simulated
            trading environments. All accounts provided to clients are simulated
            accounts. Trading in financial markets involves a high degree of risk
            and may not be suitable for all investors. The simulated capital
            provided is not real money and cannot be lost by the trader. Past
            ...
            necessary. The People Prop is not a broker and does not accept
            deposits.
          </p>
          <div className="flex flex-col items-center justify-between gap-4 text-[13px] font-medium opacity-80 sm:flex-row">
            <span>
              &copy; {new Date().getFullYear()} The People Prop. All rights
              reserved.
            </span>
            <button
